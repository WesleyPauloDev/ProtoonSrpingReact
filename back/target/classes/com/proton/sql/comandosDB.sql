...
-- Inserir um endereço
INSERT INTO endereco (bairro, cidade, complemento, estado, logradouro, nome_endereco, num_cep, num_endereco, pais, tipo_endereco)
VALUES ('Centro', 'Cidade Exemplo', 'Apto 101', 'Estado Exemplo', 'Rua Exemplo', 'Nome Endereco', '12345-678', '123', 'Brasil', 'Residencial');


-- Obter o ID do endereço inserido
SET @id_endereco = LAST_INSERT_ID();

-- Inserir um munícipe com o ID do endereço
INSERT INTO municipe (nome_municipe, senha, id_enderecoFK, data_nascimento, email, num_CPF)
VALUES ('Nome Exemplo', '123456', 1, '1990-01-01', 'email@example.com', '123.456.789-00');
